...
(function () {
  ...
  const SEARCH_INDEX = [
    ...
    { title: "Cartografia e SIG com ArcGIS e QGIS", url: "produtos.html#cartografia-sig", cat: "Produtos / Cursos" },
    { title: "AutoCAD Civil 3D para Infraestruturas", url: "produtos.html#civil3d", cat: "Produtos / Cursos" },
    { title: "Topografia Geral", url: "produtos.html#topografia-geral", cat: "Produtos / Cursos" },
    { title: "Fotogrametria com Drone", url: "produtos.html#fotogrametria-drone", cat: "Produtos / Cursos" },
    { title: "Fiscalização de Empreitada de Obras Públicas", url: "produtos.html#fiscalizacao-curso", cat: "Produtos / Cursos" },
    { title: "Excel Avançado e Power BI", url: "produtos.html#excel-powerbi", cat: "Produtos / Cursos" },
    { title: "Operador de Estação Total", url: "produtos.html#operador-estacao-total", cat: "Produtos / Cursos" },
    { title: "Operador de GPS", url: "produtos.html#operador-gps", cat: "Produtos / Cursos" },
    { title: "Operador de Nível", url: "produtos.html#operador-nivel", cat: "Produtos / Cursos" },
    { title: "Croquis de Localização", url: "produtos.html#croquis-localizacao", cat: "Produtos / Cursos" },
